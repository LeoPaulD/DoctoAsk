...
// Returns the private 'App\Repository\NouveauteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NouveauteRepository.php';

return $this->privates['App\Repository\NouveauteRepository'] = new \App\Repository\NouveauteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
