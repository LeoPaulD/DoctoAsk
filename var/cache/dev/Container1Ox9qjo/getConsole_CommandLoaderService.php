...
}, 'fos_user.command.activate_user' => function (): \FOS\UserBundle\Command\ActivateUserCommand {
    return ($this->privates['fos_user.command.activate_user'] ?? $this->load('getFosUser_Command_ActivateUserService.php'));
}, 'fos_user.command.change_password' => function (): \FOS\UserBundle\Command\ChangePasswordCommand {
    return ($this->privates['fos_user.command.change_password'] ?? $this->load('getFosUser_Command_ChangePasswordService.php'));
}, 'fos_user.command.create_user' => function (): \FOS\UserBundle\Command\CreateUserCommand {
    return ($this->privates['fos_user.command.create_user'] ?? $this->load('getFosUser_Command_CreateUserService.php'));
}, 'fos_user.command.deactivate_user' => function (): \FOS\UserBundle\Command\DeactivateUserCommand {
    return ($this->privates['fos_user.command.deactivate_user'] ?? $this->load('getFosUser_Command_DeactivateUserService.php'));
}, 'fos_user.command.demote_user' => function (): \FOS\UserBundle\Command\DemoteUserCommand {
    return ($this->privates['fos_user.command.demote_user'] ?? $this->load('getFosUser_Command_DemoteUserService.php'));
}, 'fos_user.command.promote_user' => function (): \FOS\UserBundle\Command\PromoteUserCommand {
    return ($this->privates['fos_user.command.promote_user'] ?? $this->load('getFosUser_Command_PromoteUserService.php'));
