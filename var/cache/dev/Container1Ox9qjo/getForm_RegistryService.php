...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ChatbotType' => function () {
    return ($this->privates['App\Form\ChatbotType'] ?? ($this->privates['App\Form\ChatbotType'] = new \App\Form\ChatbotType()));
...
}, 'App\\Form\\EditInfosType' => function () {
    return ($this->privates['App\Form\EditInfosType'] ?? ($this->privates['App\Form\EditInfosType'] = new \App\Form\EditInfosType()));
}, 'App\\Form\\NouveauteType' => function () {
    return ($this->privates['App\Form\NouveauteType'] ?? ($this->privates['App\Form\NouveauteType'] = new \App\Form\NouveauteType()));
...
}, 'App\\Form\\SubscribePasswordType' => function () {
    return ($this->privates['App\Form\SubscribePasswordType'] ?? ($this->privates['App\Form\SubscribePasswordType'] = new \App\Form\SubscribePasswordType()));
