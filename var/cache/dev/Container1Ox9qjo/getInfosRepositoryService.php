...
// Returns the private 'App\Repository\InfosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InfosRepository.php';

return $this->privates['App\Repository\InfosRepository'] = new \App\Repository\InfosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
